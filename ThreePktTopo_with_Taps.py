...
class ThreePktTopoScratch(Topo):
    ...
    def __init__(self):
        ...
        # Adding switches
        p1 = self.addSwitch('p1', dpid="0000000000000001", opts=opts)
        p2 = self.addSwitch('p2', dpid="0000000000000002", opts=opts)
        p3 = self.addSwitch('p3', dpid="0000000000000003", opts=opts)
